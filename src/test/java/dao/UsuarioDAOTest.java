...
//		usuarioDAO.insert(u1);
		Usuario u2 = new Usuario(2, "Felipe", "334455", "pqr1314stu", "Mecanico");
		usuarioDAO.insert(u2);
		Usuario u3 = new Usuario(3, "Miguelin", "123456", "abc456def", "Mecanico");
		usuarioDAO.insert(u3);
		Usuario u4 = new Usuario(4, "Carlos", "445566", "xyz789ijk", "Mecanico");
		usuarioDAO.insert(u4);
		Usuario u5 = new Usuario(5, "Paulina", "778899", "1011lmn12", "Mecanico");
