...
//		Reparacion r2 = new Reparacion(2, "Cambio pastillas de freno", fechaEntrada, 180.50, "Finalizada", 2, 1);
//		reparacionDAO.insert(r2);
//		Reparacion r3 = new Reparacion(3, "Fallo luces intermitentes", fechaEntrada, 75.20, "En curso", 1, 2);
