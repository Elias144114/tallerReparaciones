...
public class ControladorTaller {
	...
	public String getRol() {
		...
		// Esto para evitar problemas si alguien pone "MECANICo", "meCanico" o lo que sea. Tambien quitamos espacios
	}
	...
	public boolean registrarReparacion(Reparacion r) {
		...
		while (!usuarioValido) {
			...
			if (usuarioExistente != null && usuarioExistente.getRol().equalsIgnoreCase("mecanico")) {
				...
				usuarioValido = true;
				System.out.println("Reparación asignada a: " + usuarioExistente.getNombreUsuario());  //Lo hice así porque seria raro que un Administrador tuviera una reparacion asignada
			} else {
